				...
				<div class="card-body">
					<form action="index.php?page=list" id="filter" method="POST">
						<div class="row">
							...
							<div class="col-md-3">
								<br>
								<button class="btn-btn-block btn-primary mt-3">Ketersediaan</button>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-5" height="100%">
								...
								<div class="align-self-end mt-5">
									<button class="btn btn-primary  float-right book_now" type="button" data-id="<?php echo $row['category_id'] ?>">Pesan Sekarang</button>
								</div>
							</div>
						</div>
