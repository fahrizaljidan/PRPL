...
<div class="container-fluid">
	<p><b>Kamar : </b><?php echo isset($room['room']) ? $room['room'] : 'NA' ?></p>
	<p><b>Kategori Kamar : </b><?php echo $cat['name'] ?></p>
	<p><b>Harga : </b><?php echo 'Rp. ' . number_format($cat['price'], 2) ?></p>
	<p><b>No Referensi : </b><?php echo $ref_no ?></p>
	<p><b>Checked In : </b><?php echo $name ?></p>
	<p><b>Telepon : </b><?php echo $contact_no ?></p>
	...
	<p><b>Hari : </b><?php echo $calc_days ?></p>
	<p><b>Jumlah Pembayaran (Harga * Hari) : </b><?php echo '$' . number_format($cat['price'] * $calc_days, 2) ?></p>
